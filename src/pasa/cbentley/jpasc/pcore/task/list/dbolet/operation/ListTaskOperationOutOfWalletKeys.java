...
/**
 * List operations of funds sent out to another account that does not belong to one of your private keys
 * @author Charles Bentley
 *
 */
public class ListTaskOperationOutOfWalletKeys extends ListTaskOperationAbstract {

   private PublicKey key;

   public ListTaskOperationOutOfWalletKeys(PCoreCtx pc, IListListener<Operation> listener, PublicKey key) {
      super(pc, listener);
      this.key = key;
   }
