 ...
 *
 */
public class ListTaskPublicKeyWalletCanUse extends ListTaskPublicKeyAbstract  {


   public ListTaskPublicKeyWalletCanUse(PCoreCtx pc, IListListener<PublicKey> listener) {
      super(pc, listener);
      this.setPublicKeyFilter(new FilterKeyCanUse(pc));
   }
   ...
   public void toString(Dctx dc) {
      dc.root(this, "ListTaskPublicKeyWalletCanUse");
      toStringPrivate(dc);
   ...
   public void toString1Line(Dctx dc) {
      dc.root1Line(this, "ListTaskPublicKeyWalletCanUse");
      toStringPrivate(dc);
