...
/**
 * Access all data from DBolet RPC lib
 * 
 * @author Charles Bentley
 *
 */
public class AccessPascalRPC extends PascalAccessAbstract implements IAccessPascal {

   private AccessAccountDBoletRPCChain accessAccountRPC;

   private AccessBlockRPC   accessBlockRPC;

   public AccessPascalRPC(PCoreCtx pc) {
      super(pc);
   ...
   public void toString(Dctx dc) {
      dc.root(this, "AccessPascalRPC");
      toStringPrivate(dc);
      super.toString(dc.sup());
   }

   public void toString1Line(Dctx dc) {
      dc.root1Line(this, "AccessPascalRPC");
      toStringPrivate(dc);
